...
@section('content-admin')
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <form action="{{ route('event.update', $data->id_event) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-4">
                            <div class="input-group">
                                <input type="text" class="form-control @error('timeline') border-danger @enderror"
                                    id="timeline" name="timeline" value="{{ old('timeline', $data->timeline) }}" />
                            </div>
                            @error('timeline')
                                <div class="form-text text-danger">
                                    *{{ $message }}
                        ...
                        <div class="col-sm-4">
                            <div class="input-group">
                                <input type="text" class="form-control @error('tempat') border-danger @enderror"
                                    id="tempat" name="tempat" value="{{ old('tempat', $data->tempat) }}" />
                            </div>
                            @error('tempat')
                                <div class="form-text text-danger">
                                    *{{ $message }}
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-4">
                            <div class="input-group">
                                <input type="file" id="poster" class="form-control @error('poster') border-danger @enderror" name="poster" value="{{ old('poster', $data->poster) }}" accept="image/*" onchange="document.getElementById('output').src = window.URL.createObjectURL(this.files[0])">
                            </div>
                            @error('poster')
                                <div class="form-text text-danger">
                                    *{{ $message }}
                            ...
                            <div class="img-output mt-3 d-flex justify-content-center">
                                <img src="{{ asset('images/'.$data->poster) }}" id="output" width="280">
                            </div>
                        </div>
                    </div>
