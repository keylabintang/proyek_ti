                ...
                <tbody>
                    ...
                    @endphp
                      <tr>
                        ...
                        <td>{{ $dt->nama_ortu }}</td>
                        <td>
                          <a href="javascript:void(0);" class="badge rounded-pill bg-label-dark" data-bs-toggle="modal" data-bs-target="#bukti-pembayaran-{{ $dt->nama_anak }}">Show</a>

                          <!-- Modal -->
                          <div class="modal fade" id="bukti-pembayaran-{{ $dt->nama_anak }}" tabindex="-1" style="display: none;" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-scrollable" role="document">
                              <div class="modal-content">
                                ...
                                <div class="modal-body">
                                  <div class="row">
                                    <img src="{{ asset('images/'.$dt->bukti_pembayaran) }}" alt="bukti pembayaran">
                                  </div>
                                </div>
