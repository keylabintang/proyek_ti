      ...
      <div class="card-body">
        <form action="{{ route('prodi.store') }}" method="POST">
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-2">
              <div class="input-group">
                <input type="text" class="form-control @error('kode') border-danger @enderror" id="kode" name="kode" value="{{ old('kode') }}" />
              </div>
              @error('kode')
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-4">
              <div class="input-group">
                <input type="text" class="form-control @error('kaprodi') border-danger @enderror" id="kaprodi" name="kaprodi" value="{{ old('kaprodi') }}" />
              </div>
              @error('kaprodi')
              <div class="form-text text-danger">
                *{{ $message }}
